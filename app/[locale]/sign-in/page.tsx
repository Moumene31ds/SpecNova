        ...
        message === "auth/popup-closed-by-user"
          ...
          : message === "auth/cancelled-popup-request"
            ...
            : message === "auth/account-exists-with-different-credential"
              ? t("accountExistsDifferentCredential")
        ...
        <div className="relative z-10 p-8 md:p-10">
          ...
          <form ref={formRef} onSubmit={onSubmit} className="space-y-4" noValidate>
            ...
            <motion.button
              ...
              className={cn(
                "group/google relative w-full h-12 rounded-xl font-medium text-base transition-all",
                "border border-border/60 bg-card/80 text-foreground",
                "hover:border-border hover:bg-card hover:shadow-[0_0_24px_hsl(var(--glow-primary)/0.15)]",
                "focus:outline-none focus:ring-2 focus:ring-neon-cyan/50 focus:ring-offset-2 focus:ring-offset-background",
                "disabled:opacity-50 disabled:cursor-not-allowed",
                "overflow-hidden"
              )}
            >
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500/5 via-red-500/5 to-yellow-500/5 opacity-0 group-hover/google:opacity-100 transition-opacity duration-500" aria-hidden="true" />
              <span className="relative flex h-full items-center justify-center gap-3">
                ...
                <span>{status === "busy" ? t("signingIn") : t("googleSignIn")}</span>
              </span>
            </motion.button>
            ...
            >
              ...
              <span className="text-xs font-medium uppercase tracking-widest text-muted-foreground/50">{t("orContinueWith")}</span>
              <div className="h-px flex-1 bg-gradient-to-r from-transparent via-border to-transparent" />
            </motion.div>
