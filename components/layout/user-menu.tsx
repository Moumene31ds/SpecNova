    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          ...
          className="focus-ring inline-flex h-10 w-10 items-center justify-center rounded-xl border border-border overflow-hidden shadow-[0_0_16px_hsl(var(--glow-primary)/0.35)] transition-transform hover:scale-105"
        >
          {photoURL ? (
        ...
        <DropdownMenuLabel className="flex flex-col gap-0.5">
          <div className="flex items-center gap-2">
            ...
            {user.providerData?.[0]?.providerId === "google.com" && (
              <span className="inline-flex items-center gap-1 rounded-full bg-blue-500/10 px-1.5 py-0.5 text-[9px] font-semibold uppercase tracking-wider text-blue-400">
