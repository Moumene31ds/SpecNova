...
class SpecScraper {
    ...
    fragments = [];
    constructor() {
        this.crawler = new playwright_1.PlaywrightCrawler({
    ...
    async handleRequest(context) {
        ...
        try {
            ...
            text = await page.evaluate(() => {
                ...
                const source = candidates.find((el) => el && el.textContent && el.textContent.length > 200) ??
                    doc.document.body;
...
exports.SpecScraper = SpecScraper;
//# sourceMappingURL=crawlee-scraper.js.map